...
def parse_args():
    ...
    parser.add_argument("--dev_inn_path", help="Path to the num")
    parser.add_argument("--generate_train", default=False, action="store_true",
                        help="Generate prf training data from marco if set")
    parser.add_argument("--generate_dev", default=False, action="store_true",
                        help="Generate prf dev data")
...
if __name__ == '__main__':
    ...
    if args.generate_train:
        ...
        get_psg_embeds(args, mode="train")

    if args.generate_dev:
        generate_dev_data(args)
        get_psg_embeds(args, mode="dev")
