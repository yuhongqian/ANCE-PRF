...
def parse_args():
    ...
    parser.add_argument("--first_stage_inn_path", default="/bos/usr0/hongqiay/ANCE/results/ance_fullrank_top1K_marco")
    ...
    parser.add_argument("--ance_checkpoint_path", default="/bos/tmp10/hongqiay/ance/marco_output_np/",
                        help="location for dumpped query and passage/document embeddings which is output_dir")
    parser.add_argument("--train_data_dir",
                        default="/bos/tmp10/hongqiay/prf-query-encoder/ance_format_data/prf_encoder_100splits")
    parser.add_argument("--dev_data_dir",
                        default="/bos/tmp10/hongqiay/prf-query-encoder/ance_format_data/prf_encoder_dev")
    ...
    parser.add_argument("--preprocessed_dir", default="/bos/tmp10/hongqiay/ance/marco_preprocessed")
    ...
    parser.add_argument("--dataset", choices=["marco", "marco_eval", "trec19psg", "trec20psg"], default="marco")
...
def main():
    ...
    rerank_depths = None if args.eval_mode == "full" else [100]
    ...
    with query_cache, passage_cache:
        ...
        with torch.no_grad():
            ...
            evaluator.eval(rerank_depths=rerank_depths, mode=args.eval_mode, results=results)
    np.save(os.path.join(args.output_dir, "metrics.npy"), results)
